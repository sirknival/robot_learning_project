...
CUSTOM_LABELS = ["MT3-SAC", "MT3-SAC with Task Conditioning", "MT3-SAC with Task Conditioning + Transfer Learning", "MT3-SAC with Task Conditioning + Multi Head Critic + Curriculum Learning"]
