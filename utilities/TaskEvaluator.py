...
if __name__ == "__main__":
    ...
    # Example 1: Quick evaluation during training (for curriculum callback)
    print("Example 1: Quick Evaluation\n")

    env_factory = MetaWorldEnvFactory(verbose=False)
    ...
    # This would be called by ProgressiveTaskCallback
    # results = evaluator.evaluate_tasks(model, ["reach-v3", "push-v3"])
    # overall_perf = evaluator.get_overall_performance(results)

    print("\n" + "=" * 70 + "\n")

    # Example 2: Comprehensive final evaluation
    print("Example 2: Final Model Evaluation\n")

    final_evaluator = FinalModelEvaluator(
        env_factory=env_factory,
        tasks=MT10_TASKS[:3],  # Evaluate on first 3 tasks
        n_eval_episodes=50,
        save_results=True,
        verbose=True
    )
    ...
    # results = final_evaluator.evaluate_model(
    #     model_path="./metaworld_models/best_MT10/best_model.zip",
    #     algorithm="SAC",
    #     experiment_name="MT10_final_eval"
    # )
    ...
    #     {
    #         "name": "Baseline_MT10",
    #         "path": "./metaworld_models/MT10_SAC_5M.zip",
    #         "algorithm": "SAC"
    #     },
    #     {
    #         "name": "Curriculum_MT10",
    #         "path": "./metaworld_models/MT10_CURRICULUM_SAC_5M.zip",
    #         "algorithm": "SAC"
    #     }
    # ]

    # final_evaluator.compare_models(model_configs)
"""